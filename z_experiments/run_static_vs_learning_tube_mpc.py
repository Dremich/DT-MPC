...
def run_episode(
    ...
    for _ in range(steps):
        ...
        nominal_states.append(np.asarray(trainer.current_nominal_state, dtype=float))
...
def main():
    ...
    parser.add_argument("--num-runs", type=int, default=3, help="Number of runs per controller")
